...
<div class="row">
   ...
   <div class="col text-middle text-center">
         <p class="text-md-center hide-mobile">
            <a class="text-reset text-decoration-none" aria-current="page" href="about.html">About</a>
            <span>&nbsp;&nbsp; • &nbsp;&nbsp;</span>
            <a class="text-reset text-decoration-none" aria-current="page" href="project.html">Projects</a>
            <span>&nbsp;&nbsp; • &nbsp;&nbsp;</span>
   ...
   <div class="col text-end pe-5" style="padding-right: 2rem!important;">
      <span>
         ...
         <a id="media" href="https://www.linkedin.com/in/mujassim-bhaijamal" rel="noopener noreferrer"
            aria-label="Linkedin"
            class="p-2 text-xl text-neutral-900 dark:text-slate-200 hover:text-neutral-700 dark:hover:text-slate-100"
            target="_blank"><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 16 16"
